...
(function (window, document, $) {
  ...
  $.app.nav = {
    ...
    changeTheme: function () {
        ...
        const data = axios.post('/user/settings/theme', {}, {
            headers: {
            ...
            const changeThemeIconElement = $('.change-theme-icon');

            const themeInfoKey = Object.keys(theme).find(function (key) {
                return key !== 'next_theme_icon';
            });
            const themeInfo = theme[themeInfoKey];

            const regex = /\b\w+-layout\b/g;
            const iframe = $('iframe');
            ...
            // remove all classes that end with '-layout' and add theme layout
            htmlElement
                .removeClass(function (index, className) {
                    return (className.match(regex) || []).join(' ');
                })
                .addClass(themeInfo.style_class);

            // change theme icon
            changeThemeIconElement.replaceWith(
                `<i class="ficon change-theme-icon" data-feather="${theme.next_theme_icon}"></i>`
            );
    ...
    bind_events: function () {
      ...
      $('.navigation-main')
        ...
        .on('active.app.menu', 'li', function (e) {
          if ($(this).hasClass('navigation-without-indication')) {
            return;
          }
